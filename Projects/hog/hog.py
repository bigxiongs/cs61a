    ...
    def say(score0, score1):
    	if who == 0:
    		...
    		if increase > running_high:
    			# running_high = increase
    			print(str(increase) + ' point(s)! The most yet for Player 0')
    	...
    	if who == 1:
    		...
    		if increase > running_high:
    			# running_high = increase
    			print(str(increase) + ' point(s)! The most yet for Player 1')
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    max_score = 0
    while count <= 10:
    	average = make_averaged(roll_dice, trials_count)(count, dice)
